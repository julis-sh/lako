...
if(isset($_GET['send'])) {
    ...
    $statement->execute(array('vorname' => $vorname, 'nachname' => $nachname, 'adresse' => $adresse, 'email' => $email, 'telefon' => $telefon, 'mobil' => $mobil, 'geburtstag' => $geburtstag, 'mitgliedschaft' => $mitgliedschaft, 'bezahlung' => $bezahlung, 'kreisverband' => $kreisverband, 'essen' => $essen, 'datenschutz' => $datenschutz));
                        ...
                        <div class="p-5">
                            <form role="form" method="post" action="?send">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="vorname" id="vorname" placeholder="<?php echo $Mitglied['vorname']; ?>" value="<?php echo $Mitglied['vorname']; ?>" required="">
                                    <label for="vorname">Vorname (*)</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <input type="text" class="form-control" name="nachname" id="nachname" placeholder="<?php echo $Mitglied['nachname']; ?>" value="<?php echo $Mitglied['nachname']; ?>" required="">
                                    <label for="nachname">Nachname (*)</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <input type="adresse" class="form-control" name="adresse" id="adresse" placeholder="<?php echo $Mitglied['strasse']; ?>, <?php echo $Mitglied['plz']; ?> <?php echo $Mitglied['ort']; ?>" value="<?php echo $Mitglied['strasse']; ?>, <?php echo $Mitglied['plz']; ?> <?php echo $Mitglied['ort']; ?>" required="">
                                    <label for="adresse">Anschrift (*)</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <input type="email" class="form-control" name="email" id="email" placeholder="<?php echo $Mitglied['email']; ?>" value="<?php echo $Mitglied['email']; ?>" required="">
                                    <label for="email">E-Mail Adresse (*)</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <input type="text" class="form-control" name="telefon" id="telefon" placeholder="" value="">
                                    <label for="telefon">Telefonnummer</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <input type="text" class="form-control" name="mobil" id="mobil" placeholder="<?php echo $Mitglied['mobil']; ?>" value="<?php echo $Mitglied['mobil']; ?>">
                                    <label for="mobil">Mobilfunknummer</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <input type="text" class="form-control" name="geburtstag" id="geburtstag" placeholder="<?php echo $Mitglied['geburtsdatum']; ?>" value="<?php echo $Mitglied['geburtsdatum']; ?>" required="">
                                    <label for="geburtstag">Geburtstag (TT.MM.JJJJ) (*)</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <select class="form-control" name="mitgliedschaft" id="mitgliedschaft" placeholder="Anmelden als" value="Mitglied" required="">
                                ...
                                <div class="form-floating mt-3">
                                    <select class="form-control" name="kreisverband" id="kreisverband" placeholder="<?php echo $Mitglied['kreisverband']; ?>" value="<?php echo $Mitglied['kreisverband']; ?>" required="">
