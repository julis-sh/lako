            ...
            <div class="container pb-5" style="margin-top:-8rem">
                <div class="col-12 col-md-8 offset-md-2">
                    <div class="card text-center h-100 animation-1 reveal-1 anti-animation-blur">
                        <div class="p-5">
                            <p>
                                ...
                                Fülle dazu einfach das nachfolgende Formular aus.<br>
                                <br>
                                Wenn du deine korrekte <b>Mitgliedsnummer</b> angibst, wirst du zu einem bereits vorausgefüllten Formular weitergeleitet. Die dort angegebenen Daten kannst du natürlich nochmal ändern.<br>
                                <br>
                    ...
                    <div class="card text-center h-100 mt-4 animation-2 reveal-3 anti-animation-blur">
                        <div class="p-5">
                            <form method="post" action="mitgliedsnummer-anmeldung.php?user">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="mnr" id="mnr" placeholder="Mitgliedsnummer" value="" required="">
